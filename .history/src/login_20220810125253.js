    ...
    return(
        ...
        <div className="container">
            ...
            <div className='rightcontainer'>
                <form>   <span className="heading">Welcome Back</span>
           ...
           <label>Password</label>
            ...
            <button  onClick={signInWithGoogle}  ><div className='fri'><img src={google} className="logo" /><div className='tex'>Sign In With Google</div></div></button></form>
