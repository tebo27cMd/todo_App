                            ...
                            <div className="items" key={item.id}>
                                {
                                    item.priority == "Low" ? (
                                        ...
                                        <span>{item.task}</span>
                                        <button className="complete"><div className="Check"><CheckCircleIcon id="i" /></div></button>
                                        </div>
                                        ...
                                        <span>{item.task}</span>
                                        <button className="complete"><div className="Check"><CheckCircleIcon id="i" style={{borderBottom: "3px solid red"}}/></div></button>
