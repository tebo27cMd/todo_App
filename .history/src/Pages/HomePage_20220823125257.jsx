    ...
    return (
      <div className="AddTask">
          <div className="topPart">
              ...
              <button><div className="tick"><a href="http://getdrawings.com/logout-icon-material-design" title="Logout Icon Material Design"><img src="http://getdrawings.com/free-icon/logout-icon-material-design-56.png" width="350" /></a></div></button>
          </div>
