                            ...
                            <div className="items" key={item.id}>
                                {
                                    item.priority == "Low" ? (
                                        ...
                                        <span>{item.task}</span>
                                        <button className="complete"><div className="tick"><CheckCircleIcon id="i" /></div></button>
                                        </div>
                                        ...
                                        <span>{item.task}</span>
                                        <button className="complete"><div className="CheckCircleIcon"><CheckCircleIcon id="i" /></div></button>
